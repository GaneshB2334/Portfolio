...
// Posts arrive from app/page.js, which is a server component and does the
// Sanity fetch — this tree is "use client" and so cannot be async itself.
